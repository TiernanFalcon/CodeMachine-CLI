 ...
 * Chain Confirm Modal
 *
 * Confirmation modal shown before proceeding to the next step in a chained workflow.
 * Warns user that they cannot return to the previous step once they proceed.
 */
