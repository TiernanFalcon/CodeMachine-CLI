...
<<<<<<< HEAD:src/cli/tui/routes/workflow/adapters/__tests__/adapters.test.ts
...
>>>>>>> upstream/main:.tests.archive/__tests__/cli/tui/routes/workflow/adapters/adapters.test.ts
  });
});
